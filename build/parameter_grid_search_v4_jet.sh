#!/bin/bash
#Simple array
jetheight=(10 17 22.5 27.5 30 35 40 50)
#jetheight=(15 20 25)
    ...
    do
      ...
      do
        ...
        do
             ...
             ./testkeypoints --noiseoff=0.0 --noisestdv=0.1 --method=SWIFT --grid=1 -j 2 --staked_height=$jet_counter --input_filename_1=../../data/cloud_overlap_1.pcd --input_filename_2=../../data/cloud_overlap_1.pcd --output_filename=../measurements/SIFTtuning_3_map1_jet.csv  --min_scale_SIFT=$min_scale_SIFT_counter --nr_octaves_SIFT=$nr_octaves_SIFT_counter --nr_scales_per_octave_SIFT=$nr_scales_per_octave_SIFT_counter --min_contrast_SIFT=$min_contrast_SIFT_counter
             ./testkeypoints --noiseoff=0.0 --noisestdv=0.1 --method=SWIFT --grid=1 -j 2 --staked_height=$jet_counter --input_filename_1=../../data/cloud_nocoor.pcd --input_filename_2=../../data/cloud_overlap__big_2.pcd --output_filename=../measurements/SIFTtuning_3_map2_jet.csv  --min_scale_SIFT=$min_scale_SIFT_counter --nr_octaves_SIFT=$nr_octaves_SIFT_counter --nr_scales_per_octave_SIFT=$nr_scales_per_octave_SIFT_counter --min_contrast_SIFT=$min_contrast_SIFT_counter
        done
      done
    done
  done
